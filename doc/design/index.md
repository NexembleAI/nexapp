...
Screen reference for code generation. Each screen has a **light** and **dark** PNG in this folder. Filenames are `NN-screen-name-{light|dark}.png`. Screens are numbered 01–12 to match the order below.
...
## 01 — Splash / Launch
`01-splash-light.png` · `01-splash-dark.png`
...
## 02 — SSO Login
`02-login-light.png` · `02-login-dark.png`
...
`03-onboarding-light.png` · `03-onboarding-dark.png`
...
`04-home-light.png` · `04-home-dark.png`
...
`05-visit-capture-light.png` · `05-visit-capture-dark.png`
...
`06-queue-light.png` · `06-queue-dark.png`
...
`07-reports-light.png` · `07-reports-dark.png`
...
`08-report-detail-light.png` · `08-report-detail-dark.png`
...
`09-alerts-light.png` · `09-alerts-dark.png`
...
## 10 — Alert — Detail
`10-alert-detail-light.png` · `10-alert-detail-dark.png`
...
`11-settings-light.png` · `11-settings-dark.png`
...
`12-notifications-light.png` · `12-notifications-dark.png`
